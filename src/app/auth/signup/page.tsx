        ...
        {!showForm ? (
          ...
          <div className="absolute bottom-0 left-0 right-0 w-full flex flex-col items-center px-4 pb-6 sm:pb-8">
            ...
            <div className="space-y-2 flex flex-col w-1/3">
              <Link
                href="/auth/login"
                className="py-2.5 sm:py-3 px-6 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-full text-xs sm:text-sm shadow-lg hover:shadow-xl hover:from-purple-700 hover:to-blue-700 transition-all text-center transform hover:scale-105 duration-200 whitespace-nowrap"
              >
                Sign In
              </Link>
              <button
